...
export function S3Page() {
  ...
  const { data: sites = [] }  = useQuery({ queryKey: keys.s3WorkOrderSites(), queryFn: permitApi.s3WorkOrderSites })
            ...
            <>
              ...
              {ptwError
                ...
                : <PaginatedTable
                    ...
                    loading={ptwLoading}
                    emptyMsg={site ? 'No S2-forwarded PTWs found for the selected filters.' : 'Select a site and date range, then click Apply Filter.'}
                  />
              }
            </>
          )}
